(function(exports) {
    ...
    */
    queueCompile.prototype.handlerChainMethod = function  (patterns,promise,protoName,val,num,arr) {
        ...
        if(this.isFun(patterns)){
            ...
            [patterns].forEach(function  (methods) {
                ...
                methods( function  () { //  = api
                    ...
                    promise( (function  (v) { // this (v) can be used auto call as first param.
                        var there = this;
    ...
    queueCompile.prototype.everyModuleAcceptValue = function  (options,patterns) {
        ...
        */
        var finallyBindDataToPrototypeChain,
            i = 0,
